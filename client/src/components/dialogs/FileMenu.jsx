...
const FileMenu = ({ anchorE1, chatId, message, selectedFiles }) => {
            ...
            >
                <MenuList>
                    <MenuItem onClick={selectImage}>
                        ...
                        <ListItemText style={{ marginLeft: '0.5rem' }}>Image
                        </ListItemText>
                    ...
                    <MenuItem onClick={selectAudio}>
                        ...
                        <input type="file" multiple accept='audio/mpeg, audio/wav, audio/mp3, audio/flac'
                            style={{
                                display: 'none'
                            }}
                    ...
                    <MenuItem onClick={selectVideo}>
                        ...
                        <ListItemText style={{ marginLeft: '0.5rem' }}>Video
                        </ListItemText>
                    ...
                    <MenuItem onClick={selectFile}>
                        ...
                        <ListItemText style={{ marginLeft: '0.5rem' }}>File
                        </ListItemText>
